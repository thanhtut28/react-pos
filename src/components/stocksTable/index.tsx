...
export default function StocksTable({ columns, rows, loading }: Props) {
   ...
   return (
      <>
         {loading ? (
            ...
            <Paper
               elevation={0}
               sx={{ width: '100%', border: (theme) => `1px solid ${theme.palette.grey[300]}` }}
            >
                              ...
                              (column) =>
                                 column.isSubColumn && (
                                    <StyledTableCell
                                       key={column.id}
                                       align={column.align}
                                       style={{ top: 32, minWidth: column.minWidth }}
                                    >
                                       {column.label}
                                    </StyledTableCell>
                                 )
